...
define("_AM_SYSTEM_MODULES_DESC","در اینجا شما میتوانید ماژول‌های محتوا <br />خود را نصب کنید و یا آنها را مدیریت کنید .<br /> میدانید ماژول‌ها به چه درد میخورد؟");
...
define("_AM_SYSTEM_UNINSTALL","خارج کردن از نصب");
