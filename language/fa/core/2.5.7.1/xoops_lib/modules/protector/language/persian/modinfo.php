...
define($constpref.'_HIJACK_DENYGPDSC','مقابله با دزدی جلسه (Anti Session Hi-Jacking):<br />گروه های که IP شان در جلسه بین محتوا و کاربر نباید تغییر کند انتخاب کنید.<br />(پیشنهاد میشود فقط برای وب مستر ها روشن باشد.)<br /><br />Session Hi-Jacking(دزدی جلسه): در اصل ترکیب ماهرانه ای است از دو نوع حمله ی دزدین IP و استراق سمع با این روش حمله یک مهاجم خودش را به جای شما جا زده و اقدام به ادامه دادن کار ها و فعالیت های شما در سایت مطابق خواسته ی خود میکند البته در حدی که شما دسترسی دارید');
...
define($constpref.'_CONTAMI_ACTIONDS','رفتاری را که میخواید در برابر کاربری که قصد وارد کمردن داده های نا مناسب به سیستم محتوا شما را دارد انجام شود مشخص کنید.<br />(پیشنهاد میشود بر روی صفحه ی سفید قرار دهید)');
...
//3.40b
define($constpref."_ADMINHOME","صفحه اصلی");
define($constpref."_ADMINABOUT","درباره ماژول");
//3.50
define($constpref.'_STOPFORUMSPAM_ACTION','Stop Forum Spam');
define($constpref.'_STOPFORUMSPAM_ACTIONDSC','نوشته های ارسال شده را در وبسایت www.stopforumspam.com و در پایگاه داده آن بررسی کرده و در صورت اسپم بودن ارسال کننده وی را بلاک خواهد کرد. نیازمند به php CURL lib.');
