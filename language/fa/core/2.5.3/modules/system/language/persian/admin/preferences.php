...
define("_MD_AM_METAKEYDSC", "کلمات کلیدی سرویسی است که به طور خلاصه محتوای سایت شما را مشخص می‌کند. این کلمات را به وسیله‌ی کاما یا اسپیس از هم جدا کنید. (مانند PHP, mySQL, portal system)");
...
define("_MD_AM_SOAP_FILTERPERSONDESC","حساب‌های اختصاصی که از تایید صندیت محتوا استفاده میکنند.");
...
define("_MD_AM_SOAP_FIELDMAPPING","فیلدهای جستجوی کارگزار Auth");
define("_MD_AM_SOAP_FIELDMAPPINGDESC","توضیح این نقشه برداری بین فیلد‌های پایگاه داده‌های محتوا و فیلد‌های سندیت سیستم LDAP ." .
		"<br><br>شکل [Database field]=[Auth system SOAP attribute]" .
...
define("_MD_AM_AUTH_CONFOPTION_XOOPS", "پایگاه‌داده محتوا");
define("_MD_AM_AUTH_CONFOPTION_LDAP", "شاخه LDAP استاندارد");
define("_MD_AM_AUTH_CONFOPTION_AD", "شاخه و کپی فعال مایکروسافت");
define("_MD_AM_AUTH_CONFOPTION_SOAP", "گزینه تایید سندیت Soap محتوا");
...
define("_MD_AM_LDAP_USERS_BYPASS_DESC", "سندیت کاربران به وسیله روش داخلی محتوا");
...
define("_MD_AM_LDAP_LOGINLDAP_ATTR_D", "وقتی نام کاربری استفاده شده در تنظیمات DN بر روی بله تنظیم شده باشد، باید با نام کاربری محتوا یکی باشد");
define("_MD_AM_LDAP_LOGINNAME_ASDN", "نام ورود استفاده شده در DN");
define("_MD_AM_LDAP_LOGINNAME_ASDN_D", "نام کاربری محتوا که در LDAP DN استفاده شده است (eg : uid=<loginname>,dc=mohtava,dc=com)<br>ورودی مستقیما از کارگزار LDAP خوانده می‌شود بدون جستجو");
...
define("_MD_AM_LDAP_PROVIS", "تدارک خودکار شناسه‌ی محتوا");
define("_MD_AM_LDAP_PROVIS_DESC", "ساخت پایگاه‌‌های‌داده‌ی کاربر محتوا در صورت عدم وجود");
...
define("_MD_AM_LDAP_FIELD_MAPPING_ATTR", "فیلدهای جستجوی کارگزار Auth");
define("_MD_AM_LDAP_FIELD_MAPPING_DESC", "توضیح این نقشه برداری بین فیلد‌های پایگاه داده‌های محتوا و فیلد‌های سندیت سیستم LDAP ." .
		"<br /><br />شکل [Database field]=[Auth system LDAP attribute]" .
		"<br />برای مثال : email=mail" .
		"<br />به وسیله | از هم جدا کنید" .
		"<br /><br />!! برای کاربران حرفه ای !!");
		
define("_MD_AM_LDAP_PROVIS_UPD", "قوانین نگهداری حساب کاربری محتوا");
define("_MD_AM_LDAP_PROVIS_UPD_DESC", "حساب‌های کاربری محتوا همیشه با سرویس دهنده‌ی تایید سدندیت هماهنگ میشوند");
