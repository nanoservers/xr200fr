...
define($constpref."_DESC","اين ماژول سايت محتوا شما را در برابر حملات ويروسي و لینک ‌های داس نفوذ به پایگاه داده ‌ها و ... محافظت ميکند.");
...
define($constpref.'_RELIABLE_IPSDSC','IP ‌ها را با | از هم جدا کنید . ابتدا ردیف را با ^ مشخص کنید, انت‌های ردیف را با $.');
...
define($constpref.'_HIJACK_DENYGP','گره ‌های که IP اجازه ی تغییر در جلسه ( بین کاربر و محتوا) را ندارد');
...
define($constpref.'_DISABLES','خصوصيات خطرناک در محتوا رو غير فعال کن');
