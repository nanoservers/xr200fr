...
define( "RECOMMENDED_SETTINGS", "تنظیمات پیشن‌هادی" );
define( "RECOMMENDED_EXTENSIONS", "افزونه‌‌های پیشن‌هادی" );
define( "SETTING_NAME", "نام تنظیمات" );
define( "RECOMMENDED", "پیشن‌هاد شده" );
define( "CURRENT", "فعلی" );
define( "RECOMMENDED_EXTENSIONS_MSG", "این افزونه‌‌ها برای استفاده معمولی لازم نمی‌باشد، اما شاید برای بعضی از امکانات اضافی به آن‌ها نیاز باشد 
 (مثل سایت‌‌های چند زبانه و پشتیبانی از RSS). بنابراین، نصب آن‌ها الزامی است." );
define( "NONE", "هیچکدام" );
...
define( "XOOPS_INSTALL_WIZARD", "جادوی نصب محتوا" );

define( "LANGUAGE_SELECTION", "انتخاب زبان" );
define( "LANGUAGE_SELECTION_TITLE", "زبان مورد نظر خود را انتخاب کنید");		// L128
define( "INTRODUCTION", "معرفی محتوا" );
define( "INTRODUCTION_TITLE", "به دستیار نصب محتوا خوش‌آمدید" );		// L0
define( "CONFIGURATION_CHECK", "برسی تنظیمات" );
define( "CONFIGURATION_CHECK_TITLE", "برسی تنظیمات کارگزار شما" );
define( "PATHS_SETTINGS", "تنظیمات مسیر‌ها" );
define( "PATHS_SETTINGS_TITLE", "تنظیمات مسیر‌ها" );
...
define( "WELCOME_TITLE", "به سایت محتوا خود خوش آمدید" );		// L0


// Settings (labels and help text)
define( "XOOPS_PATHS", "شاخه‌ی فیزیکی محتوا" );
define( "XOOPS_URLS", "آدرس اینترنتی" );

define( "XOOPS_ROOT_PATH_LABEL", "شاخه‌ی فیزیکی محل قرار گیری هسته محتوا" ); // L55
define( "XOOPS_ROOT_PATH_HELP", "محل فیزیکی پرونده ‌های محتوا بر روی کارگزار" ); // L59

define( "XOOPS_LIB_PATH_LABEL", "شاخه‌ی کتابخانه‌‌های محتوا" );
define( "XOOPS_LIB_PATH_HELP", "مسیر شاخه‌ی کتابخانه‌ٔ محتوا بودن باید با اسلش پایانی باشد. برای امنیت بیشتر این شاخه را به خارج از " . XOOPS_ROOT_PATH_LABEL . " منتقل کنید.");
define( "XOOPS_DATA_PATH_LABEL", "شاخه‌ی پرونده‌‌های داده‌ی محتوا" );
define( "XOOPS_DATA_PATH_HELP", "مسیر شاخه‌ی پرونده‌‌های داده محتوا (قابل نوشتن) بدون نیاز به اسلش پایانی. برای امنیت بیشتر این شاخه را به خارج از " . XOOPS_ROOT_PATH_LABEL . " منتقل کنید." );

define( "XOOPS_URL_LABEL", "آدرس وب‌سایت (URL)" ); // L56
define( "XOOPS_URL_HELP", "آدرسی اصلی که بعد از نصب محتوا برای دسترسی به سایت از آن استفاده می‌کنید" ); // L58
...
define( "DB_COLLATION_HELP",  "تنظيم مقايسه گر برای مقايسه‌ی كاراكتر‌ها.");
...
define( "READY_CREATE_TABLES", "هیچ کدام از جدول‌‌های محتوا پیدا نشد.<br />سیستم نصب آماده است که الان جدول‌‌های محتوا را بسازد.<br />با کلیک بر روی دکمه <em>بعدی</em> این کار انجام می‌شود." );
define( "XOOPS_TABLES_FOUND", "جدول‌‌های سیستم محتوا در حال حاضر در پایگاه‌‌های داده‌ای شما موجود است.<br />با کلیک بروید دکمه <em>بعدی</em> به مرحله بعدی بروید." ); // L131
define( "XOOPS_TABLES_CREATED", "سیستم جدول‌‌های محتوا ساخته شد.<br />با استفاده از دکمه <em>بعدی</em> به مرحله بعد بروید." );
...
define( "DATA_ALREADY_INSERTED", "اطلاعات محتوا در پایگاه‌‌های داده‌ٔ شما پیدا شد.<br />با کلیک بر روی دکمه <em>بعدی</em> به مرحله بعدی بروید." );
...
define( "ERR_NO_XOOPS_FOUND", "سیستم نصب محتوا نمی‌تواند شاخه‌ی مشخص شده را پیدا کند." );
...
define( "ERR_NEED_WRITE_ACCESS", "در کارگزار باید به شاخه‌‌ها و پرونده‌‌های تعیین شده در ادامه دسترسی نوشتن داده شود<br />(مثلا<em>دسترسی 777 directory_name</em> در کارگزار‌های UNIX/LINUX)" ); // L72
...
define( "ERR_CHARSET_NOT_SET", "نویسه‌ی پیش فرض تنظیم شده در پایگاه‌‌های داده‌ی محتوا تنظیم نشد." );
