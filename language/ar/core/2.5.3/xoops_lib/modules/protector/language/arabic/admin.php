...
define("_AM_EZ_PREFIX", "بادئة الجدول");
define("_AM_EZ_TABLES", "الجداول");
define("_AM_EZ_UPDATED", "تحديث");
define("_AM_EZ_COPY", "نسخ");
define("_AM_EZ_ACTIONS", "الإجراءات");
define("_AM_EZ_BACKUP", "نسخ إحتياطي");
