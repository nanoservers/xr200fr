...
// Manager
define("_AM_SYSTEM_COMMENTS_NAV_MANAGER","Comment Manager");
...
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_DATE_AFTER","After this date (white for any date)");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_DATE_BEFORE","Before this date (white for any date)");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_GROUPS","Groups");
define("_AM_SYSTEM_COMMENTS_FORM_PURGE_USER","Nickname of the user");
