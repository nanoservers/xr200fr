...
define( "INTRODUCTION_TITLE", "Welcome to the MOHTAVA installation assistant" );        // L0
...
define( "XOOPS_DATA_PATH_LABEL", "MOHTAVA datafiles directory" );
define( "XOOPS_DATA_PATH_HELP", "Physical path to the MOHTAVA datafiles (writable) directory WITHOUT trailing slash, for forward compatibility. Locate the folder out of " . XOOPS_ROOT_PATH_LABEL . " to make it secure." );
...
define( "DATA_ALREADY_INSERTED", "MOHTAVAdata found in database.<br />Press <em>next</em> to go to the next step." );
