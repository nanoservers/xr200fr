<?php
// $Id: auth.php 11355 2013-04-07 03:14:28Z beckmi $
// _LANGCODE: en
// _CHARSET : UTF-8
// Translator: XOOPS Translation Team

define('_AUTH_MSG_AUTH_METHOD',"using MOHTAVA authentication method");
...
define('_AUTH_LDAP_XOOPS_USER_NOTFOUND',"Sorry, no corresponding user information has been found in the MOHTAVA database for connection: %s <br>" . "Please verify your user data or set on the automatic provisioning");
