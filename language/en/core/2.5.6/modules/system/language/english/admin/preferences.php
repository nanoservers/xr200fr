 ...
 * _LANGCODE    en
 * _CHARSET     UTF-8
 * @version     $Id: preferences.php 11355 2013-04-07 03:14:28Z beckmi $
 */
...
define("_MD_AM_CUSTOM_REDIRECT_DESC","replace old redirection by jGrowl redirection<br />jGrowl is a jQuery plugin that raises unobtrusive messages within the MOHTAVA");
...
define("_MD_AM_METAKEYDSC","The keywords meta tag is a series of keywords that represents the content of your site. Type in keywords with each separated by a comma or a space in between. (Ex. MOHTAVA, PHP, mySQL, portal system)");
...
define("_MD_AM_SOAP_FILTERPERSONDESC","Special Accounts that use MOHTAVA Authentication.");
...
define("_MD_AM_LDAP_USERS_BYPASS_DESC","Users to be authenticated with native MOHTAVA method");
...
define("_MD_AM_LDAP_LOGINLDAP_ATTR_D","When Login name use in the DN option is set to yes, must correspond to the login name MOHTAVA");
define("_MD_AM_LDAP_LOGINNAME_ASDN","Login name use in the DN");
define("_MD_AM_LDAP_LOGINNAME_ASDN_D","The MOHTAVA login name is used in the LDAP DN (eg : uid=<loginname>,dc=mohtava,dc=com)<br>The entry is directly read in the LDAP Server without search");
...
define("_MD_AM_LDAP_PROVIS","Automatic MOHTAVA account provisionning");
define("_MD_AM_LDAP_PROVIS_DESC","Create MOHTAVA user database if not exists");
...
define("_MD_AM_LDAP_FIELD_MAPPING_ATTR","MOHTAVA-Auth server fields mapping");
define("_MD_AM_LDAP_FIELD_MAPPING_DESC","Describe here the mapping between the MOHTAVA database field and the LDAP Authentication system field." .
        "<br /><br />Format [MOHTAVA Database field]=[Auth system LDAP attribute]" .
        "<br />for example : email=mail" .
        "<br />Separate each with a |" .
        "<br /><br />!! For advanced users !!");

define("_MD_AM_LDAP_PROVIS_UPD","Maintain MOHTAVA account provisionning");
define("_MD_AM_LDAP_PROVIS_UPD_DESC","The MOHTAVA User account is always synchronized with the Authentication Server");
