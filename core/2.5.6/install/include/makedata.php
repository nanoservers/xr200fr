...
* @version $Id: makedata.php 9488 2012-05-12 10:39:59Z beckmi $
*/
...
function make_data(&$dbm, $adminname, $adminpass, $adminmail, $language, $gruops)
{
    ...
    // default theme
    $time = time();
    $dbm->insert('tplset', " VALUES (1, 'default', 'MOHTAVA Default Template Set', '', " . $time . ")");
    // system modules
    ...
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by mohtava &#169; 2001-" . date('Y', time()) . " <a href=\"http://xoops.sourceforge.net\" rel=\"external\" title=\"The XOOPS Project\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
