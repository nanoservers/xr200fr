 ...
 * @package     system
 * @version     $Id: main.php 10346 2012-12-10 04:48:14Z beckmi $
 */
...
//  Check is active
if ( !xoops_getModuleOption('active_maintenance', 'system') ) redirect_header( 'admin.php', 2, _AM_SYSTEM_NOTACTIVE );
...
switch ($op) {
	...
	case 'list': default:
		...
		$cache_arr = array(1 => 'smarty_cache',
						  2 => 'smarty_compile',
						  3 => 'xoops_cache');
