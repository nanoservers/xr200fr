...
function make_data(&$dbm, $adminname, $adminpass, $adminmail, $language, $gruops)
{
    ...
    $dbm->insert("banner", " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlcode) VALUES (1, 1, 0, 1, 0, '', 'http://www.mohtava.com/', 1008813250, '')");
    $dbm->insert("banner", " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlcode) VALUES (2, 1, 0, 1, 0, '', 'http://www.mohtava.com/', 1008813250, '')");
    $dbm->insert("banner", " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlcode) VALUES (3, 1, 0, 1, 0, '', 'http://www.mohtava.com/', 1008813250, '')");
    // default theme
    $time = time();
    ...
    $dbm->insert('config', " VALUES (1, 0, 1, 'sitename', '_MD_AM_SITENAME', 'MOHTAVA Site', '_MD_AM_SITENAMEDSC', 'textbox', 'text', 0)");
    ...
    $dbm->insert('config', " VALUES (34, 0, 2, 'bad_unames', '_MD_AM_BADUNAMES', '" . addslashes(serialize(array('webmaster', '^MOHTAVA', '^admin'))) . "', '_MD_AM_BADUNAMESDSC', 'textarea', 'array', 24)");
    $dbm->insert('config', " VALUES (35, 0, 2, 'bad_emails', '_MD_AM_BADEMAILS', '" . addslashes(serialize(array('mohtava.com$'))) . "', '_MD_AM_BADEMAILSDSC', 'textarea', 'array', 26)");
    ...
    $dbm->insert('config', " VALUES (38, 0, 3, 'meta_keywords', '_MD_AM_METAKEY', 'MOHTAVA, web applications, web 2.0, sns, news, technology, headlines, linux, software, download, downloads, free, community, forum, bulletin board, bbs, php, survey, polls, kernel, comment, comments, portal, odp, open source, opensource, FreeSoftware, gnu, gpl, license, Unix, *nix, mysql, sql, database, databases, web site, blog, wiki, module, modules, theme, themes, cms, content management', '_MD_AM_METAKEYDSC', 'textarea', 'text', 0)");
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by MOHTAVA &#169; 2001-" . date('Y', time()) . " <a href=\"http://mohtava.com\" rel=\"external\" title=\"The MOHTAVA Project\">The MOHTAVA Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    ...
    $dbm->insert('config', " VALUES (49, 0, 3, 'meta_author', '_MD_AM_METAAUTHOR', 'MOHTAVA', '_MD_AM_METAAUTHORDSC', 'textbox', 'text', 6)");
    ...
    $dbm->insert('config', " VALUES (51, 0, 3, 'meta_description', '_MD_AM_METADESC', 'MOHTAVA is a dynamic Object Oriented based open source portal script written in PHP.', '_MD_AM_METADESCDSC', 'textarea', 'text', 1)");
    ...
    $dbm->insert('config', " VALUES (77,0,7,'ldap_base_dn','_MD_AM_LDAP_BASE_DN','dc=mohtava,dc=com','_MD_AM_LDAP_BASE_DN_DESC','textbox','text',4)");
