<?php
// $Id: main.php 7301 2011-08-24 09:45:49Z forxoops $
//  ------------------------------------------------------------------------ //
...
$xoTheme->addScript('browse.php?modules/system/js/jquery.easing.js');
$xoTheme->addScript('browse.php?modules/system/js/jqueryFileTree.js');
$xoTheme->addScript('browse.php?modules/system/js/admin.js');
$xoTheme->addScript('browse.php?modules/system/js/templates.js');
$xoTheme->addScript('browse.php?modules/system/js/code_mirror/codemirror.js');
// Define Stylesheet
...
switch ($op) {
	...
	default:
		...
		$ele = new XoopsFormSelect(_AM_SYSTEM_TEMPLATES_SET, 'tplset', $GLOBALS['xoopsConfig']['tplset']);
