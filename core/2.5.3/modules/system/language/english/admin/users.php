...
define("_AM_SYSTEM_USERS_OCCUPATION","Occupation");
...
define("_AM_SYSTEM_USERS_MAILOK","Only users that accept mail");
define("_AM_SYSTEM_USERS_MAILNG","Only users that don't accept mail");
...
define("_AM_SYSTEM_USERS_USERPOST","User Posts");
define("_AM_SYSTEM_USERS_STORIES","Stories");
define("_AM_SYSTEM_USERS_COMMENTS","Comments");
define("_AM_SYSTEM_USERS_PTBBTSDIYT","Push the button below to synchronize data if you think the above user posts info does not seem to indicate the actual status");
