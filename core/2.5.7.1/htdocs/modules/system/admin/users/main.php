<?php
// $Id: main.php 12036 2013-09-14 04:58:55Z beckmi $
//  ------------------------------------------------------------------------ //
...
switch ($op) {
    ...
    case "users_save":
        ...
        if (isset($_REQUEST['uid'])) {
            ...
            if ( !isset( $_REQUEST['attachsig'] ) ) $attachsig = null;
            if ( !isset( $_REQUEST['user_viewemail'] ) ) $user_viewemail = null;
        ...
        if (isset($_REQUEST['complet_search'])) {
            ...
            //echo $requete_search;
                foreach (array_keys($users_arr) as $i) {
                    ...
                    $users['name'] = $users_arr[$i]->getVar("uid");
