...
define('_MD_AM_LDAP_LOGINNAME_ASDN_D',"The MOHTAVA login name is used in the LDAP DN (eg : uid=<loginname>,dc=xoops,dc=org)<br>The entry is directly read in the LDAP Server without search");
