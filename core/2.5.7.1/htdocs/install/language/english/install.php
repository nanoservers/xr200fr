...
define('XOOPS_INSTALL_WIZARD',"MOHTAVA Installation Wizard");
...
define('INTRODUCTION_TITLE',"Welcome to the MOHTAVA Installation Wizard");        // L0
...
define('WELCOME_TITLE',"Welcome to your MOHTAVA site");        // L0
// Settings (labels and help text)
define('XOOPS_PATHS',"MOHTAVA Physical paths");
define('XOOPS_URLS',"Web locations");
define('XOOPS_ROOT_PATH_LABEL',"MOHTAVA documents root physical path");
define('XOOPS_ROOT_PATH_HELP',"Physical path to the MOHTAVA documents (served) directory WITHOUT trailing slash");
define('XOOPS_LIB_PATH_LABEL',"MOHTAVA library directory");
define('XOOPS_LIB_PATH_HELP',"Physical path to the MOHTAVA library directory WITHOUT trailing slash, for forward compatibility. Locate the folder out of " . XOOPS_ROOT_PATH_LABEL . " to make it secure.");
define('XOOPS_DATA_PATH_LABEL',"MOHTAVA data files directory");
define('XOOPS_DATA_PATH_HELP',"Physical path to the MOHTAVA data files (writable) directory WITHOUT trailing slash, for forward compatibility. Locate the folder out of " . XOOPS_ROOT_PATH_LABEL . " to make it secure.");
define('XOOPS_URL_LABEL',"Website location (URL)"); // L56
define('XOOPS_URL_HELP',"Main URL that will be used to access your MOHTAVA installation"); // L58
...
define('XOOPS_TABLES_FOUND',"The MOHTAVA system tables already exists in your database.<br />Press <em>next</em> to go to the next step."); // L131
define('XOOPS_TABLES_CREATED',"MOHTAVA system tables have been created.<br />Press <em>next</em> to go to the next step.");
...
define('DATA_ALREADY_INSERTED',"MOHTAVA data found in database.<br />Press <em>next</em> to go to the next step.");
...
define('ERR_NO_XOOPS_FOUND',"No MOHTAVA installation could be found in the specified folder.");
...
define('ERR_CHARSET_NOT_SET',"Default character set is not set for MOHTAVA database.");
...
//2.5.7
define('WRITTEN_LICENSE',"Written MOHTAVA %s License Key: <strong>%s</strong>");
