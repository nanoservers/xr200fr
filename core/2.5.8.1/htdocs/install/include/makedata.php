 ...
 *
 * @copyright       (c) 2000-2016 XOOPS Project (www.mohtava.com)
 * @license             GNU GPL 2 or later (http://www.gnu.org/licenses/gpl-2.0.html)
 * @package             installer
 * @since               2.3.0
 * @author              Haruki Setoyama <haruki@planewave.org>
 * @author              Kazumi Ono <webmaster@myweb.ne.jp>
 * @author              Skalpa Keo <skalpa@mohtava.com>
 * @author              Taiwen Jiang <phppp@users.sourceforge.net>
 * @author              DuGris (aka L. JEN) <dugris@frmohtava.com>
 * @param $dbm
 * @return bool
 */
...
function make_data(&$dbm, $adminname, $hashedAdminPass, $adminmail, $language, $groups)
{
    ...
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (1, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/xoops_flashbanner2.htm', 'http://www.mohtava.com/', 1008813250, 1,'')");
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (2, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/xoops_banner_2.gif', 'http://www.mohtava.com/', 1008813250, 0, '')");
    $dbm->insert('banner', " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlbanner, htmlcode) VALUES (3, 1, 0, 1, 0, '" . XOOPS_URL . "/images/banners/banner.htm', 'http://www.mohtava.com/', 1008813250, 1, '')");
    // default theme
    $time = time();
    ...
    $dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS &#169; 2001-" . date('Y', time()) . " <a href=\"http://mohtava.com\" rel=\"external\" title=\"The XOOPS Project\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    ...
    $dbm->insert('config', " VALUES (74,0,7,'auth_method','_MD_AM_AUTHMETHOD','mohtava','_MD_AM_AUTHMETHODDESC','select','text',1)");
