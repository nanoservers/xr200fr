...
define('_MI_EXTGAL_DESC',"eXtGallery is a powerful web gallery module for MOHTAVA");
...
define('_MI_EXTGAL_FORM_OPTIONS_DESC',"Select the editor to use. If you have a 'simple' install (e.g you use only MOHTAVA core editor class, provided in the standard MOHTAVA core package), then you can just select DHTML and Compact");
...
define('_MI_EXTGAL_PERPAGEـRSSـDSC',"Select number of new photos in RSS page");
define('_MI_EXTGAL_TIMECACHEـRSS',"RSS cache time");
define('_MI_EXTGAL_TIMECACHEـRSSـDSC',"Cache time for RSS pages in minutes");
define('_MI_EXTGAL_LOGOـRSS',"Site logo for RSS pages");
