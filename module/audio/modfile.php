...
switch ($op)
{
	// Vue liste	case "list" :
		...
		// r�f�rencement		// titre de la page		$pagetitle = _MD_AUDIO_SINGLEFILE_MODIFY . ' - ' . $view_downloads->getVar ( 'title' ) . ' - ';
		$pagetitle .= audio_PathTreeUrl ( $mytree, $view_downloads->getVar ( 'cid' ), $downloadscat_arr, 'cat_title', $prefix = ' - ', false, 'DESC', true );
		$xoopsTpl->assign ( 'xoops_pagetitle', $pagetitle );
		//description		$xoTheme->addMeta ( 'meta', 'description', strip_tags ( _MD_AUDIO_SINGLEFILE_MODIFY . ' (' . $view_downloads->getVar ( 'title' ) . ')' ) );
