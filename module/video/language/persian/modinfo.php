<?php
// Non du module
define("_MI_VIDEO_NAME", "ویدیو");

// Description du module
define("_MI_VIDEO_DESC", "ماژول ویدیو حرفه ای با امکان ارسال و تبدیل فرمت و نمایش ویدیو");

// Bloc
define("_MI_VIDEO_BNAME1", "ویدیو های اخیر");
define("_MI_VIDEO_BNAMEDSC1", "نمایش ویدیو های اخیر");
define("_MI_VIDEO_BNAME2", "برترین ویدیو ها");
define("_MI_VIDEO_BNAMEDSC2", "نمایش برترین ویدیو ها");
define("_MI_VIDEO_BNAME3", "ویدیو هایی با بیشترین رای");
define("_MI_VIDEO_BNAMEDSC3", "نمایش ویدیو ها با بیشترین رای");
define("_MI_VIDEO_BNAME4", "ویدیو های تصادفی");
define("_MI_VIDEO_BNAMEDSC4", "نمایش ویدیو های تصادفی");
define("_MI_VIDEO_BNAME5", "ویدئوهای انتخابی");
define("_MI_VIDEO_BNAMEDSC5", "");
define("_MI_VIDEO_BNAME6", "نمایش ویدیو");
define("_MI_VIDEO_BNAMEDSC6", "");
define("_MI_VIDEO_BNAME7", "ویدیو های اخیر جدولی");
define("_MI_VIDEO_BNAMEDSC7", "نمایش ویدیو های اخیر به صورت جدولی");
define("_MI_VIDEO_BNAME8", "اسپات لایت");
define("_MI_VIDEO_BNAMEDSC8", "اسپات لایت");

// Sous menu
define("_MI_VIDEO_SMNAME1", "ارسال");
define("_MI_VIDEO_SMNAME2", "جستجو");
define("_MI_VIDEO_SMNAME3", "شبکه");

// Menu administration
define("_MI_VIDEO_ADMENU1", "صفحه اصلی");
define("_MI_VIDEO_ADMENU2", "شاخه ها");
define("_MI_VIDEO_ADMENU3", "ویدیو ها");
define("_MI_VIDEO_ADMENU4", "خراب");
define("_MI_VIDEO_ADMENU5", " ویرایش شده");
define("_MI_VIDEO_ADMENU6", "فیلد اضافی");
define("_MI_VIDEO_ADMENU7", "درباره");
define("_MI_VIDEO_ADMENU8", "دسترسی");
define("_MI_VIDEO_ADMENU9", "به روز کردن");
define("_MI_VIDEO_ADMENU10", "وارد کردن اطلاعات");
...
// Notifications
define('_MI_VIDEO_GLOBAL_NOTIFY', 'سراسرس');
define('_MI_VIDEO_GLOBAL_NOTIFYDSC', 'اگاهی رسانی های سراسری دریافت ویدیو.');
define('_MI_VIDEO_CATEGORY_NOTIFY', 'شاخه');
define('_MI_VIDEO_CATEGORY_NOTIFYDSC', "تنظیمات اطلاع رسانی که برای همین شاخه به کار میرود.");
define('_MI_VIDEO_FILE_NOTIFY', 'ویدیو');
define('_MI_VIDEO_FILE_NOTIFYDSC', "تنظیمات اطلاع رسانی که برای همین ویدیو به کار میرود.");
define('_MI_VIDEO_GLOBAL_NEWCATEGORY_NOTIFY', 'شاخه جدید');
define('_MI_VIDEO_GLOBAL_NEWCATEGORY_NOTIFYCAP', 'هرگاه شاخه جدیدی ایجاد شد مرا باخبر کن.');
define('_MI_VIDEO_GLOBAL_NEWCATEGORY_NOTIFYDSC', "هرگاه شاخه جدیدی ایجاد شد به من ارسال کن");
define('_MI_VIDEO_GLOBAL_NEWCATEGORY_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:شاخه جدید');
define('_MI_VIDEO_GLOBAL_FILEMODIFY_NOTIFY', 'اطلاع رسانی خودکار:شاخه جدید');
define('_MI_VIDEO_GLOBAL_FILEMODIFY_NOTIFYCAP', 'هر گاه درخواستی برای اصلاح ویدیو رسید مرا با خبر کن.');
define('_MI_VIDEO_GLOBAL_FILEMODIFY_NOTIFYDSC', "هر گاه درخواستی برای اصلاح ویدیو رسید به من ارسال کن.");
define('_MI_VIDEO_GLOBAL_FILEMODIFY_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE}  اطلاع رسانی خودکار: درخواست اصلاح ویدیو');
define('_MI_VIDEO_GLOBAL_FILEBROKEN_NOTIFY', 'Broken File Submitted');
define('_MI_VIDEO_GLOBAL_FILEBROKEN_NOTIFYCAP', 'هر گزارشی راجع به ارسال ویدیو خراب از سایت رسید مرا با خبر کن.');
define('_MI_VIDEO_GLOBAL_FILEBROKEN_NOTIFYDSC', 'هر گزارشی راجع به ارسال ویدیو  خراب از سایت رسید به من ارسال کن.');
define('_MI_VIDEO_GLOBAL_FILEBROKEN_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:ارسال ویدیو از خارج سایت‌');
define('_MI_VIDEO_GLOBAL_FILESUBMIT_NOTIFY', 'ویدیو ارسال شده');
define('_MI_VIDEO_GLOBAL_FILESUBMIT_NOTIFYCAP', "هر ویدیوی ارسال شد مرا با خبر کن (awaiting approval).");
define('_MI_VIDEO_GLOBAL_FILESUBMIT_NOTIFYDSC', "هر ویدیوی ارسال شد به من ارسال کن (awaiting approval).");
define('_MI_VIDEO_GLOBAL_FILESUBMIT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:ویدیو ارسال شده');
define('_MI_VIDEO_GLOBAL_NEWFILE_NOTIFY', 'ویدیو جدید');
define('_MI_VIDEO_GLOBAL_NEWFILE_NOTIFYCAP', "هر ویدیو جدیدی ارسال شد مرا با خبر کن.");
define('_MI_VIDEO_GLOBAL_NEWFILE_NOTIFYDSC', 'هر ویدیو جدیدی ارسال شد به من ارسال کن.');
define('_MI_VIDEO_GLOBAL_NEWFILE_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:ویدیو جدید');
define('_MI_VIDEO_CATEGORY_FILESUBMIT_NOTIFY', 'ویدیو ثبت شده');
define('_MI_VIDEO_CATEGORY_FILESUBMIT_NOTIFYCAP', "هر ویدیو جدیدی ثبت شد مرا با خبر کن.");
define('_MI_VIDEO_CATEGORY_FILESUBMIT_NOTIFYDSC', "هر ویدیو جدیدی ثبت شد به من ارسال کن.");
define('_MI_VIDEO_CATEGORY_FILESUBMIT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE}  اطلاع رسانی خودکار:ویدیو ثبت شده در شاخه');
define('_MI_VIDEO_CATEGORY_NEWFILE_NOTIFY', 'ویدیو جدید');
define('_MI_VIDEO_CATEGORY_NEWFILE_NOTIFYCAP', "وقتی یک ویدیو در همین شاخه قرار گرفت مرا با خبر کن.");
define('_MI_VIDEO_CATEGORY_NEWFILE_NOTIFYDSC', "وقتی یک ویدیو در همین شاخه قرار گرفت به من ارسال کن.");
define('_MI_VIDEO_CATEGORY_NEWFILE_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:ویدیو جدید در شاخه');
define('_MI_VIDEO_FILE_APPROVE_NOTIFY', 'ویدیو تایید شده');
define('_MI_VIDEO_FILE_APPROVE_NOTIFYCAP', 'هر ویدیوی تایید شد مرا با خبر کن.');
define('_MI_VIDEO_FILE_APPROVE_NOTIFYDSC', 'هر ویدیوی تایید شد به من ارسال کن.');
define('_MI_VIDEO_FILE_APPROVE_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} اطلاع رسانی خودکار:ویدیو تایید شده');

// version 1.25
define('_MI_VIDEO_SHOW_EXTRA', 'اطلاعات اضافی');
