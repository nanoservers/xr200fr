...
class mp4
{
    ...
    public function mp4($ffmpeg, $srcPath, $destPath, $outWidth, $outHeight, $sampleRate, $bitRate, $acodec, $vcodec, $rate, $maxRate, $logo, $overlayHeight, $overlayWidth)
    {
    ...
    public function convert($input, $output, $type = 'normal')
    {
        ...
        // ffmpeg -i input.mp4 -s 640x480 -ab 128000  -ar 44000 -f mp4 output.mp4
        ...
        // ffmpeg -i input.mp4 -s 400x300 -acodec libfaac -vcodec libx264 -vpre max -r 30  -maxrate 1000 -ab 16000  -ar 16000 -f mp4 -vf 'movie=/home/voltan/logo.png [logo];[in][logo] overlay=50:50:1 [out]' output.mp4

        switch ($type) {
            case 'short':
                $command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -f mp4 -s " . $this->outputWidth . "x" . $this->outputHeight . " " . $this->destPath . "\\" . $this->output;
                break;

            case 'normal':
                //$command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -acodec " . $this->acodec . " -vcodec " . $this->vcodec . " -r " . $this->rate . " -maxrate " . $this->maxRate . " -f mp4 -s " . $this->outputWidth . "x" . $this->outputHeight . " " . $this->destPath . "\\" . $this->output;
                $command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -s " . $this->outputWidth . "x" . $this->outputHeight . " -aspect 4:3 -maxrate " . $this->maxRate . " -r " . $this->rate . " -vcodec " . $this->vcodec . " -vpre fastfirstpass -acodec " . $this->acodec . " -ac 1 -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -f mp4  " . $this->destPath . "\\" . $this->output;
                break;

            case 'local':
                //$command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -acodec " . $this->acodec . " -vcodec " . $this->vcodec . " -r " . $this->rate . " -maxrate " . $this->maxRate . " -f mp4 -s " . $this->outputWidth . "x" . $this->outputHeight . " " . $this->destPath . "\\" . $this->output;
                $command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -s " . $this->outputWidth . "x" . $this->outputHeight . " -aspect 4:3 -maxrate " . $this->maxRate . " -r " . $this->rate . " -vcodec " . $this->vcodec . " -acodec " . $this->acodec . " -ac 1 -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -f mp4  " . $this->destPath . "\\" . $this->output;
                break;

            case 'logo':
                //$command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -acodec " . $this->acodec . " -vcodec " . $this->vcodec . " -r " . $this->rate . " -maxrate " . $this->maxRate . " -f mp4 -s " . $this->outputWidth . "x" . $this->outputHeight . " -vf 'movie=" . $this->logo . " [logo];[in][logo] overlay=" . $this->overlayWidth . ":" . $this->overlayHeight . ":1 [out]' " . $this->destPath . "\\" . $this->output;
                $command = $this->ffmpegPath . " -i " . $this->srcPath . "\\" . $this->input . " -s " . $this->outputWidth . "x" . $this->outputHeight . " -aspect 4:3 -maxrate " . $this->maxRate . " -r " . $this->rate . " -vcodec " . $this->vcodec . " -vpre fastfirstpass -acodec " . $this->acodec . " -ac 1 -ar " . $this->audioSampleRate . " -ab " . $this->audioBitRate . " -f mp4 -vf 'movie=" . $this->logo . " [logo];[in][logo] overlay=" . $this->overlayWidth . ":" . $this->overlayHeight . ":1 [out]' " . $this->destPath . "\\" . $this->output;
                break;
        }
