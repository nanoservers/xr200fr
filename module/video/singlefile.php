...
switch ($view_downloads->getVar('type')) {
    ...
    case 'ntv':
        ...
        if ($view_downloads->getVar('filename2')) {
            $flashFile2 = $view_downloads->getVar('url') . $uploadpach_ntv . $view_downloads->getVar('filename2');
        }

        if ($view_downloads->getVar('filename3')) {
            $flashFile3 = $view_downloads->getVar('url') . $uploadpach_ntv . $view_downloads->getVar('filename3');
        }
        break;
}
