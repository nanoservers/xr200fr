...
switch ($view_downloads->getVar('type')) {
    case 'flv':
    ...
    case 'mp4':
        switch ($quality) {
            ...
            case 'medium':
                $url = $view_downloads->getVar('url', 'n') . "/uploads/video/mp4/" . $view_downloads->getVar('filename2', 'n') . ".mp4";
                break;

            case 'high':
                $url = $view_downloads->getVar('url', 'n') . "/uploads/video/mp4/" . $view_downloads->getVar('filename3', 'n') . ".mp4";
                break;
        }
        break;
    ...
    case 'ntv':
        switch ($quality) {
            case 'low':
                $nameLow = str_replace('.ntv', '.mp4', $view_downloads->getVar('filename', 'n'));
                $url = $view_downloads->getVar('url', 'n') . "/uploads/video/mp4/" . $nameLow;
                break;

            case 'medium':
                $nameMedium = str_replace('.ntv', '.mp4', $view_downloads->getVar('filename2', 'n'));
                $url = $view_downloads->getVar('url', 'n') . "/uploads/video/mp4/" . $nameMedium;
                break;

            case 'high':
                $nameHigh = str_replace('.ntv', '.mp4', $view_downloads->getVar('filename3', 'n'));
                $url = $view_downloads->getVar('url', 'n') . "/uploads/video/mp4/" . $nameHigh;
                break;
        }
        break;
}
